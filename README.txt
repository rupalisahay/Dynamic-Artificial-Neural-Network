...
4. Enter path and name of the file to be preprocessed
...
5. Enter path and name of the preprocessed file to form the ANN

6. Then input the following,
	a) Percent of the dataset to be used for training
	b) Maximum number of iterations
	c) Number of hidden layers
	d) Neurons in each hidden layer
